...
from ..cli.baseline_state import (
    CloneBaselineState,
...
from ..cli.report_meta import _build_report_meta, _current_report_timestamp_utc
    ...
    def _evaluate_gate_snapshot(
        ...
        *,
        ...
        return _evaluate_report_gates(
            ...
            baseline_status=str(
                self._as_mapping(
                    self._as_mapping(record.report_document.get("meta")).get("baseline")
                ).get("status", "")
            ),
