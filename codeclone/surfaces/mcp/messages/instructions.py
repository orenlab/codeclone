...
SERVER_INSTRUCTIONS: Final = (
    ...
    "get_implementation_context for bounded structural, call-graph, contract, and "
    "change-control evidence from one stored run (help(topic=implementation_context); "
    "codeclone-implementation-context skill). Use list_hotspots or focused "
