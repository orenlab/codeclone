...
SESSION_STATS_ACTIVE_AGENTS: Final = "Active agents:"
...
SESSION_STATS_MCP_FOOTPRINT: Final = "MCP payload footprint"
SESSION_STATS_MCP_FOOTPRINT_VERBOSE: Final = (
    "MCP payload footprint: ~{tokens:,} tokens ({encoding}, {calls} tool calls)"
)
SESSION_STATS_WORKSPACE_INTENTS_TITLE: Final = "Workspace intents"
...
SESSION_STATS_QUIET_TEMPLATE: Final = (
    "{prefix} {workspace_health} | agents={agents} intents={intents} "
