...
# Average-size gate over statement batches (validate_claims paragraph units,
# propose_memory candidate batches). Warn-level only. Live-store mean was
# 147 chars over 3,828 records; measured markdown overhead is ~+11% (~163);
