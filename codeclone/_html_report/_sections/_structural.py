...
from ...report.findings import _dedupe_items, _finding_scope_text, _spread
from ...report.json_contract import structural_group_id
from ...report.suggestions import (
