...
""".strip(),
    ...
    boot = BootstrapResult(
        ...
        args=Namespace(
            ...
            skip_dependencies=True,
            skip_dead_code=False,
            # The claim here is about entry points as liveness EVIDENCE; the
            # world is held closed so the uncalled public function stays the
            # dead control instead of becoming an open-world abstention.
