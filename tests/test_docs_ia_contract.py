...
_PUBLIC_NAV_PAGES = (
    ...
    "concepts/health-explainability.md",
    "concepts/complexity.md",
    "concepts/near-miss-clones.md",
    "concepts/unreachable-statements.md",
    "concepts/source-kinds.md",
    "concepts/baseline-container.md",
    "concepts/semantic-authority.md",
    "guides/agent-safe-change.md",
    "guides/engineering-memory-workflow.md",
    "guides/migration-a1-a2.md",
