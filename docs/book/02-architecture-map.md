...
| Setup readiness         | `codeclone/surfaces/cli/setup/*`, `codeclone/config/pyproject_writer.py`, `codeclone/utils/atomic_write.py`, `codeclone/paths/gitignore.py`                      | Lazy-loaded `codeclone setup` argv route; capability snapshot; read-only plan; bounded pyproject/gitignore apply (no MCP intent)                                                                                                        |
...
- `codeclone/surfaces/cli/setup/main.py:setup_main`
...
| Repository setup and readiness        | [../guide/setup/readiness-and-apply.md](../guide/setup/readiness-and-apply.md)                                                                                                                                                                                                 |
...
| Corpus analytics (intent clustering)  | [27-corpus-analytics.md](27-corpus-analytics.md)                                                                                                                                                                                                                               |
