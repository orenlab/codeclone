...
| Engineering Memory      | `codeclone/memory/*`, `codeclone/config/memory*.py`                                                                           | Local SQLite store, init ingest, scoped retrieval, staleness, governance, CLI/MCP surfaces over deterministic report/git/doc facts                                                                  |
