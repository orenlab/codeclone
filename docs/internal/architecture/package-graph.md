...
| **Schema version** | 3.1 (report) | REPORT_SCHEMA_VERSION from contracts/__init__.py |
...
|----------|--------|--------|--------|
| Module count (769) | `codeclone_mcp_module_map` | supported | Retrieved via get_report_section; REPORT_SCHEMA_VERSION=3.1 |
