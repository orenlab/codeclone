...
| `CACHE_VERSION` | `"4.1"` | analysis cache store | Invalidates `.codeclone/db/cache.sqlite3` on mismatch. Bump on cache schema or serialization change. See the note below. |
